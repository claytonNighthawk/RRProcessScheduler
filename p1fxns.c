 ...
 */
int p1strneq(const char *str1, const char *str2, int n){
    int i;
 ...
 *
 *  packs str into buf, with a field width fw, appending fill character fillChar
 *      to str to make up fw;
 *      if fw < 0, packs fillChar before str, up to a field width of |fw|;
 ...
 */
char *p1strpack(char *str, int fw, char fillChar, char *buf){
    char *p = buf;
    int n = p1strlen(str);
    int nb;
