    ...
    for (int j = 0; j < 3; j++) {
        ...
        switch (j) {
            case 0:
                ...
                p1putstr(STDOUT_FILENO, "cmdline: ");
                p1putstr(STDOUT_FILENO, data);
                p1putstr(STDOUT_FILENO, "\n");
                // printf("cmdline: %s\n", data);
                break;
            ...
            case 1:
                ...
                p1putstr(STDOUT_FILENO, "stats: ");
                while ((i = p1getword(data, i, word)) != -1) {
                    words++;
                    switch (words) {
                        case 14:
                            p1putstr(STDOUT_FILENO, "usrModeTime: ");
                            p1putstr(STDOUT_FILENO, word);
                            // printf("usrModeTime: %s ", word);
                            break;
                        case 15:
                            p1putstr(STDOUT_FILENO, " sysModeTime: ");
                            p1putstr(STDOUT_FILENO, word);
                            // printf("sysModeTime: %s ", word);
                            break;
                        case 23:
                            p1putstr(STDOUT_FILENO, " virtualMemSize: ");
                            p1putstr(STDOUT_FILENO, word);
        ...
        case SIGALRM:
            if (alarmsEnabled) {
                ...
                if (currentPCB->isFinished) {
                    ...
                    p1putstr(STDOUT_FILENO, "switching process:\n");
                    parseProc();
                }
